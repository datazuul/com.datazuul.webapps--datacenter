package com.datazuul.utils.backend.repository.database;
 ...
 * @author ralf
 */
public class SchemaGeneratorAnnotatedClasses {

  private final Configuration cfg;

  /**
   * Example: java SchemaGeneratorAnnotatedClasses com.datazuul.webapps.contact.domain src/main/resources/sql/generated/
   *
  ...
  public static void main(String[] args) throws Exception {
    ...
    SchemaGeneratorAnnotatedClasses gen = new SchemaGeneratorAnnotatedClasses(packageName);
    ...
    gen.generate(Dialect.DERBY, directory);
  }

  public SchemaGeneratorAnnotatedClasses(String packageName) throws Exception {
